    ...
    pub fn run(self: *Self) !void {
        ...
        while (true) {
            ...
            switch (command.command_type) {
                ...
                readline.CommandType.file_header => try handler.analysis.fileHeader(self),
                readline.CommandType.program_headers => try handler.analysis.programHeaders(self),
                ...
                readline.CommandType.export_table => try handler.analysis.exportTable(self),
                readline.CommandType.import_table => try handler.analysis.importTable(self),
